...
public class LangEntity
{
	...
	public static final String	TAG			= "LT-LangEntity";

	public LangEntity(int entityID, boolean phrase, boolean phrase_partial,
	...
	public static ArrayList<LangEntity> getEntities(Context ctx, String topicId)
	{
		DatabaseAdapter sDba = new DatabaseAdapter(ctx);
		SQLiteDatabase sDb = sDba.getWritableDatabase();

		ArrayList<LangEntity> elist = new ArrayList<LangEntity>();
		...
		while (!d.isAfterLast())
		{
			elist.add(new LangEntity(d.getInt(0), (d.getInt(1) > 0), (d.getInt(2) > 0), d.getString(3), d.getString(4), (d.getInt(5) > 0), d.getString(6)));
			d.moveToNext();
		}
