	...
	public boolean onMenuItemSelected(int featureId, MenuItem item)
	{
		switch (item.getItemId())
		{
			case CREATE_NEW_PROFILE :
				Intent createProfile_intent = new Intent(LoginActivity.this, CreateProfileActivity.class);
				startActivityForResult(createProfile_intent, REQUEST_CREATENEW);
				break;
			case RECOVER_PASS :
				Intent recover_intent = new Intent(LoginActivity.this, ProfileSelectionActivity.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data)
	{
		switch (requestCode)
		{
			case REQUEST_CREATENEW :
				...
				{
					int newProfileID = data.getIntExtra(CreateProfileActivity.NEW_PROFILEID, -1);
					if (newProfileID == -1)
					{
